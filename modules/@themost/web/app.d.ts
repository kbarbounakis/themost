...
export declare class HttpApplication extends SequentialEventEmitter {
    ...
    readonly handlers: Array<RequestHandler>;
    ...
    getConfiguration():HttpConfiguration;
    getExecutionPath(): string;
    use(handler: RequestHandler): HttpApplication;
    useStaticContent(rootDir: string, options?: ServeStaticOptions): HttpApplication;
    useStrategy(serviceCtor: Function, strategyCtor: Function): HttpApplication;
    useService(serviceCtor: Function): HttpApplication;
    hasStrategy(serviceCtor: Function): HttpApplication;
    hasService(serviceCtor: Function): HttpApplication;
    getStrategy(serviceCtor: Function): HttpApplication;
    getService(serviceCtor: Function): HttpApplication;
