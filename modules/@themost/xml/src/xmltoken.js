...
const XML10_NAME_CHAR = XML10_LETTER + XML10_DIGIT + '\\._:' +
...
const XML10_ATT_VALUE = '"(([^<&"]|' + XML10_REFERENCE + ')*)"|' +
    "'(([^<&']|" + XML10_REFERENCE + ")*)'";
...
const XML11_ATT_VALUE = '"(([^<&"]|' + XML11_REFERENCE + ')*)"|' +
    "'(([^<&']|" + XML11_REFERENCE + ")*)'";
...
const XML_NC_NAME_CHAR = XML10_LETTER + XML10_DIGIT + '\\._' +
    XML10_COMBINING_CHAR + XML10_EXTENDER + '-';
const XML_NC_NAME = '[' + XML10_LETTER + '_][' + XML_NC_NAME_CHAR + ']*';

const XML_TOKEN = {
    XML10_VERSION_INFO: XML10_VERSION_INFO,
    XML10_NAME: XML10_NAME,
    XML10_ATTRIBUTE: XML10_ATTRIBUTE,
    XML11_VERSION_INFO: XML11_VERSION_INFO,
    XML11_NAME: XML11_NAME,
    XML11_ATTRIBUTE: XML11_ATTRIBUTE,
    XML_NC_NAME: XML_NC_NAME
}

export const XML_TOKEN;
