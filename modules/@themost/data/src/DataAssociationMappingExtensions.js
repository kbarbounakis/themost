...
class DataAssociationMappingExtensions {
     /**
    ...
    static extend(mapping) {
        ...
        return {
            ...
            getChildModel: function() {
                ...
                if (_.isObject(_childModel)) {
                    return _childModel;
                }
                _childModel = thisQueryable.model.context.model(mapping.childModel);
                return _childModel;
            ...
            getParentModel: function() {
                ...
                if (_.isObject(_parentModel)) {
                    return _parentModel;
                }
                _parentModel = thisQueryable.model.context.model(mapping.parentModel);
                return _parentModel;
            },
            /**
             * @param {*} items
             ...
             * @returns {Promise|*}
             */
            getAssociatedChildren_v1: function(items) {
                const thisArg = this;
                const deferred = Q.defer();
                process.nextTick(() => {
                    if (_.isNil(items)) {
...
export {DataAssociationMappingExtensions};
